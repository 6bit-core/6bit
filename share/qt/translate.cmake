...
function(extract_strings output)
  ...
  file(STRINGS "sixbitstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *sixbit_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"sixbit-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/sixbitstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/sixbitstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/sixbit_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/sixbit_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/sixbit_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/sixbit_en.xlf" SIXBIT_EN_XLF)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" SIXBIT_EN_XLF "${SIXBIT_EN_XLF}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" SIXBIT_EN_XLF "${SIXBIT_EN_XLF}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/sixbit_en.xlf" "${SIXBIT_EN_XLF}")