...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"sixbit-cli -h\" for help or \"sixbit-cli listwallets\" to see "
...
class TestsixbitCli(SixBitTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `sixbit-cli getblockchaininfo`")
        ...
        # Prevent sixbit-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and sixbit-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and sixbit-cli getwalletinfo return expected wallet info")
            ...
            # Test sixbit-cli -generate with -rpcwallet in multiwallet mode.
