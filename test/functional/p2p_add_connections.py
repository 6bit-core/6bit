...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The sixbitd node closes feeler connections as soon as a version
...
class P2PAddConnections(SixBitTestFramework):
    ...
    def run_test(self):
        ...
        # sixbitd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that sixbitd sends its own version prior to processing
