...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SixBitTestFramework
    pass


class ExampleTest(SixBitTestFramework):
    # Each functional test is a subclass of the SixBitTestFramework class.
    ...
    def custom_method(self):
        ...
        SixBitTestFramework class so other tests can use it."""
