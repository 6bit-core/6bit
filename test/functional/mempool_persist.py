...
By default, sixbitd will dump mempool on shutdown and
...
class MempoolPersistTest(SixBitTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent sixbitd from writing mempool.dat to disk. Verify that `savemempool` fails")
