...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/sixbit/sixbit/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(SixBitTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/sixbit/sixbit/blob/master/doc/tracing.md#tracepoint-validationblock_connected
