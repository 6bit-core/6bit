...
class TestShell:
    """Wrapper Class for SixBitTestFramework.

    The TestShell class extends the SixBitTestFramework
    ...
    class __TestShell(SixBitTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by SixBitTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # SixBitTestFramework instances are supposed to be constructed with the path
