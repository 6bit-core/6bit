...
"""Verify that starting sixbit with -h works as expected."""

from test_framework.test_framework import SixBitTestFramework
from test_framework.util import assert_equal

class HelpTest(SixBitTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sixbit with -h for help text")
        ...
        self.log.info("Start sixbit with -version for version information")
        ...
        self.log.info("Start sixbitd with -fakearg to make sure it does not start")
