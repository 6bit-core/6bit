...
class BumpFeeTest(SixBitTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 coins (100,000 satoshis)
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by sixbit to serialize ECDSA signatures means that signatures can have a
