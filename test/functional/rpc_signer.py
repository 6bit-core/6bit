...
Verify that a sixbitd node can use an external signer command.
...
class RPCSignerTest(SixBitTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart sixbitd with -signer=<cmd>',
