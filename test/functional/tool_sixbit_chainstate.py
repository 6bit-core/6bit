...
class sixbitChainstateTest(SixBitTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_sixbit_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing sixbit-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    sixbitChainstateTest(__file__).main()
