...
export CONTAINER_NAME=ci_native_nowallet_li.sixbitkernel
...
export GOAL="install"
export SIXBIT_CONFIG="-DREDUCE_EXPORTS=ON -DBUILD_UTIL_CHAINSTATE=ON -DBUILD_KERNEL_LIB=ON -DBUILD_SHARED_LIBS=ON"
