...
Compiled with GCC 1.0.0 with -O3, on an Intel(R) Core(TM) i7-4800MQ CPU, numbers in CPU cycles:
...
Results of a formal review of the code can be found in http:/.sixbit.sipa.be/ctaes/review.zip
