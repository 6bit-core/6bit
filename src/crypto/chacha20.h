...
#ifndef SIXBIT_CRYPTO_CHACHA20_H
#define SIXBIT_CRYPTO_CHACHA20_H
...
public:
     ...
     * to as the '32-bit fixed-common part' in Example 1.0.0 of RFC8439.
     *
...
#endif // SIXBIT_CRYPTO_CHACHA20_H
