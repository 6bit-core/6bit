...
#ifndef SIXBIT_PROTOCOL_H
#define SIXBIT_PROTOCOL_H
...
/**
 * sixbit protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Sixbit Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // 6bit.development mailing list. Remember that service bits are just
