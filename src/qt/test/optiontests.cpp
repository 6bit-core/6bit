...
{
    // Test regression https://github.com.sixbit.sixbit/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/sixbit-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/sixbit-core/gui/pull/568.
    // With fListen=false in ~/.config/sixbit.sixbit.Qt.conf and all else left as default,
    // sixbit-qt should set both -listen and -listenonion to false and start successfully.
