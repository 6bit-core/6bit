...
//! Entry point for SixbitApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &SixbitApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for SixbitGUI tests.
void AppTests::guiTests(SixbitGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &SixbitGUI::consoleShown, this, &AppTests::consoleTests);
