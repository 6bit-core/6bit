      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->sixbitAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->sixbitAtStartup);
    ...
    ui->sixbitAtStartup->setToolTip(ui->sixbitAtStartup->toolTip().arg(CLIENT_NAME));
    ui->sixbitAtStartup->setText(ui->sixbitAtStartup->text().arg(CLIENT_NAME));

    ui->opensixbitConfButton->setToolTip(ui->opensixbitConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new sixbitUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->sixbitAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_opensixbitConfButton_clicked()
{
