...
#ifndef SIXBIT_QT_OPTIONSMODEL_H
#define SIXBIT_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for sixbit client.
...
public:
    ...
    sixbitUnit getDisplayUnit() const { return m_display_sixbit_unit; }
...
private:
    ...
    QString language;
    sixbitUnit m_display_sixbit_unit;
...
Q_SIGNALS:
    void displayUnitChanged(sixbitUnit unit);
...
#endif // SIXBIT_QT_OPTIONSMODEL_H
