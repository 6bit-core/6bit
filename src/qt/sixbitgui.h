...
#ifndef SIXBIT_QT_6BITGUI_H
#define SIXBIT_QT_6BITGUI_H
...
/**
  sixbit GUI main class. This class represents the main window of the sixbit UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SixbitGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SixbitGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~SixbitGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a.sixbit wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, sixbitUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed sixbit Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(sixbitUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // SIXBIT_QT_6BITGUI_H
