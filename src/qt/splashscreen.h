...
#ifndef SIXBIT_QT_SPLASHSCREEN_H
#define SIXBIT_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Sixbit Core initialization
...
#endif // SIXBIT_QT_SPLASHSCREEN_H
