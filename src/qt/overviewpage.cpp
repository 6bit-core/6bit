...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = sixbitUnits::formatWithUnit(unit, amount, true, sixbitUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    sixbitUnit unit{sixbitUnit::SIXBIT};
...
{
    sixbitUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(sixbitUnits::formatWithPrivacy(unit, balances.balance, sixbitUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(sixbitUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, sixbitUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(sixbitUnits::formatWithPrivacy(unit, balances.immature_balance, sixbitUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(sixbitUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, sixbitUnits::SeparatorStyle::ALWAYS, m_privacy));
