...
#ifndef SIXBIT_QT_GUIUTIL_H
#define SIXBIT_QT_GUIUTIL_H
...
/** Utility functions used by the sixbit Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse .sixbit:" URI into recipient object, return true on successful parsing
