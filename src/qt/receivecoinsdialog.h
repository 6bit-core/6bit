...
#ifndef SIXBIT_QT_RECEIVECOINSDIALOG_H
#define SIXBIT_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of.sixbits */
...
#endif // SIXBIT_QT_RECEIVECOINSDIALOG_H
