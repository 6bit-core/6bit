...
#ifndef SIXBIT_QT_WALLETVIEW_H
#define SIXBIT_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a.sixbit wallet, and offers access to
