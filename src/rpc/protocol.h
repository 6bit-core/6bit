...
#ifndef SIXBIT_RPC_PROTOCOL_H
#define SIXBIT_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in sixbitd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< sixbit is not connected
