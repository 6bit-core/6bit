...
static RPCHelpMan addnode()
{
    return RPCHelpMan{
        ...
        "Attempts to add or remove a node from the addnode list.\n"
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("addnode", "\"1.0.0.6:16666\" \"onetry\" true")
            + HelpExampleRpc("addnode", "\"1.0.0.6:16666\", \"onetry\" true")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan addconnection()
{
    return RPCHelpMan{
        ...
        RPCExamples{
            HelpExampleCli("addconnection", "\"1.0.0.6:16666\" \"outbound-full-relay\" true")
            + HelpExampleRpc("addconnection", "\"1.0.0.6:16666\" \"outbound-full-relay\" true")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan disconnectnode()
{
    return RPCHelpMan{
        ...
        "Immediately disconnects from the specified peer node.\n"
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"1.0.0.6:16666\"")
            + HelpExampleCli("disconnectnode", "\"\" 1")
            + HelpExampleRpc("disconnectnode", "\"1.0.0.6:16666\"")
...
static RPCHelpMan getaddednodeinfo()
{
    return RPCHelpMan{
        ...
        "Returns information about the given added node, or all added nodes\n"
                    ...
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::ARR, "addresses", "Only when connected = true",
                            {
                                {RPCResult::Type::OBJ, "", "",
                                {
                                    {RPCResult::Type::STR, "address", "The.sixbit server IP and port we're connected to"},
                ...
                RPCExamples{
                    HelpExampleCli("getaddednodeinfo", "\"1.0.0.201\"")
            + HelpExampleRpc("getaddednodeinfo", "\"1.0.0.201\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    NodeContext& node = EnsureAnyNodeContext(request.context);
...
static RPCHelpMan setban()
{
    return RPCHelpMan{
        ...
        "Attempts to add or remove an IP/Subnet from the banned list.\n",
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("setban", "\"1.0.0.6\" \"add\" 86400")
                            + HelpExampleCli("setban", "\"1.0.0.0/24\" \"add\"")
                            + HelpExampleRpc("setban", "\"1.0.0.6\", \"add\", 86400")
                },
...
static RPCHelpMan addpeeraddress()
{
    return RPCHelpMan{"addpeeraddress",
        ...
        RPCExamples{
            HelpExampleCli("addpeeraddress", "\"1.0.0.4\" 8333 true")
    + HelpExampleRpc("addpeeraddress", "\"1.0.0.4\", 8333, true")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
