...
#ifndef SIXBIT_TEST_SCRIPTNUM10_H
#define SIXBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Sixbit Core 1.0.0, for cross-comparison.
 */
public:
...
#endif // SIXBIT_TEST_SCRIPTNUM10_H
