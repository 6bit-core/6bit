...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As sixbit relies on 80 byte header hashes, we want to have an example for that.",
...
{
    /* Example from RFC8439 section 1.0.0. */
    TestChaCha20("",
...
BOOST_AUTO_TEST_CASE(chacha20poly1305_testvectors)
{
    ...
    // RFC 8439 Example from section 1.0.0
