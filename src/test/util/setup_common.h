...
#ifndef SIXBIT_TEST_UTIL_SETUP_COMMON_H
#define SIXBIT_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com.sixbit.sixbit/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // SIXBIT_TEST_UTIL_SETUP_COMMON_H
