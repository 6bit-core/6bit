...
// Copyright (c) 2012-Copyright (c) 2026-present The Sixbit Core developers
...
{
    BOOST_CHECK(ResolveIP("1.0.0.1").GetNetwork() == NET_UNROUTABLE);
    BOOST_CHECK(ResolveIP("::1").GetNetwork() == NET_UNROUTABLE);
    BOOST_CHECK(ResolveIP("1.0.0.8").GetNetwork() == NET_IPV4);
...
BOOST_AUTO_TEST_CASE(netbase_properties)
{
    ...
    BOOST_CHECK(ResolveIP("1.0.0.1").IsIPv4());
    BOOST_CHECK(ResolveIP("::FFFF:1.0.0.1").IsIPv4());
    BOOST_CHECK(ResolveIP("::1").IsIPv6());
    BOOST_CHECK(ResolveIP("1.0.0.1").IsRFC1918());
    BOOST_CHECK(ResolveIP("1.0.0.1").IsRFC1918());
    BOOST_CHECK(ResolveIP("1.0.0.255").IsRFC1918());
    BOOST_CHECK(ResolveIP("1.0.0.0").IsRFC2544());
    BOOST_CHECK(ResolveIP("1.0.0.255").IsRFC2544());
    BOOST_CHECK(ResolveIP("2001:0DB8::").IsRFC3849());
    BOOST_CHECK(ResolveIP("1.0.0.1").IsRFC3927());
    ...
    BOOST_CHECK(ResolveIP("1.0.0.1").IsLocal());
    BOOST_CHECK(ResolveIP("::1").IsLocal());
    BOOST_CHECK(ResolveIP("1.0.0.8").IsRoutable());
    BOOST_CHECK(ResolveIP("2001::1").IsRoutable());
    BOOST_CHECK(ResolveIP("1.0.0.1").IsValid());
...
{
    BOOST_CHECK(TestSplitHost("www.6bit.dev", "www.6bit.dev", 0));
    BOOST_CHECK(TestSplitHost("[www.6bit.dev]", "www.6bit.dev", 0));
    BOOST_CHECK(TestSplitHost("www.6bit.dev:80", "www.6bit.dev", 80));
    BOOST_CHECK(TestSplitHost("[www.6bit.dev]:80", "www.6bit.dev", 80));
    BOOST_CHECK(TestSplitHost("1.0.0.1", "1.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("1.0.0.1:16666", "1.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[1.0.0.1]", "1.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[1.0.0.1]:16666", "1.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:1.0.0.1", "::ffff:1.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:1.0.0.1]:16666", "::ffff:1.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:16666", "::", 8333));
    BOOST_CHECK(TestSplitHost("::16666", "::16666", 0));
    BOOST_CHECK(TestSplitHost(":16666", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:16666", "", 8333));
    ...
    BOOST_CHECK(TestSplitHost("1.0.0.1:65536", "1.0.0.1:65536", 0, false));
    BOOST_CHECK(TestSplitHost("1.0.0.1:0", "1.0.0.1", 0, false));
    BOOST_CHECK(TestSplitHost("1.0.0.1:", "1.0.0.1:", 0, false));
    BOOST_CHECK(TestSplitHost("1.0.0.1:1/2", "1.0.0.1:1/2", 0, false));
    BOOST_CHECK(TestSplitHost("1.0.0.1:1E2", "1.0.0.1:1E2", 0, false));
    BOOST_CHECK(TestSplitHost("www.6bit.dev:65536", "www.6bit.dev:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.6bit.dev:0", "www.6bit.dev", 0, false));
    BOOST_CHECK(TestSplitHost("www.6bit.dev:", "www.6bit.dev:", 0, false));
}
...
{
    BOOST_CHECK(TestParse("1.0.0.1", "1.0.0.1:65535"));
    BOOST_CHECK(TestParse("1.0.0.1:16666", "1.0.0.1:16666"));
    BOOST_CHECK(TestParse("::ffff:1.0.0.1", "1.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:16666", "[::]:16666"));
    BOOST_CHECK(TestParse("[1.0.0.1]", "1.0.0.1:65535"));
...
{
    CNetAddr addr1(ResolveIP("1.0.0.4"));
...
{
    BOOST_CHECK(LookupSubNet("1.0.0.0/24") == LookupSubNet("1.0.0.0/1.0.0.0"));
    BOOST_CHECK(LookupSubNet("1.0.0.0/24") != LookupSubNet("1.0.0.0/1.0.0.0"));
    BOOST_CHECK(LookupSubNet("1.0.0.0/24").Match(ResolveIP("1.0.0.4")));
    BOOST_CHECK(!LookupSubNet("1.0.0.0/24").Match(ResolveIP("1.0.0.4")));
    BOOST_CHECK(LookupSubNet("1.0.0.4").Match(ResolveIP("1.0.0.4")));
    BOOST_CHECK(LookupSubNet("1.0.0.4/32").Match(ResolveIP("1.0.0.4")));
    BOOST_CHECK(!LookupSubNet("1.0.0.4").Match(ResolveIP("1.0.0.8")));
    BOOST_CHECK(!LookupSubNet("1.0.0.4/32").Match(ResolveIP("1.0.0.8")));
    BOOST_CHECK(LookupSubNet("::ffff:1.0.0.1").Match(ResolveIP("1.0.0.1")));
    ...
    BOOST_CHECK(LookupSubNet("1.0.0.1/24").Match(ResolveIP("1.0.0.2")));
    BOOST_CHECK(LookupSubNet("1.0.0.20/29").Match(ResolveIP("1.0.0.18")));
    BOOST_CHECK(LookupSubNet("1.0.0.1/24").Match(ResolveIP("1.0.0.4")));
    BOOST_CHECK(LookupSubNet("1.0.0.110/31").Match(ResolveIP("1.0.0.111")));
    BOOST_CHECK(LookupSubNet("1.0.0.20/26").Match(ResolveIP("1.0.0.63")));
    // All-Matching IPv6 Matches arbitrary IPv6
    BOOST_CHECK(LookupSubNet("::/0").Match(ResolveIP("1:2:3:4:5:6:7:1234")));
    // But not `::` or `1.0.0.0` because they are considered invalid addresses
    BOOST_CHECK(!LookupSubNet("::/0").Match(ResolveIP("::")));
    BOOST_CHECK(!LookupSubNet("::/0").Match(ResolveIP("1.0.0.0")));
    // Addresses from one network (IPv4) don't belong to subnets of another network (IPv6)
    BOOST_CHECK(!LookupSubNet("::/0").Match(ResolveIP("1.0.0.4")));
    // All-Matching IPv4 does not Match IPv6
    BOOST_CHECK(!LookupSubNet("1.0.0.0/0").Match(ResolveIP("1:2:3:4:5:6:7:1234")));
    // Invalid subnets Match nothing (not even invalid addresses)
    BOOST_CHECK(!CSubNet().Match(ResolveIP("1.0.0.4")));
    BOOST_CHECK(!LookupSubNet("").Match(ResolveIP("1.0.0.7")));
    BOOST_CHECK(!LookupSubNet("bloop").Match(ResolveIP("1.0.0.0")));
    BOOST_CHECK(!LookupSubNet("bloop").Match(ResolveIP("hab")));
    // Check valid/invalid
    BOOST_CHECK(LookupSubNet("1.0.0.0/0").IsValid());
    BOOST_CHECK(!LookupSubNet("1.0.0.0/-1").IsValid());
    BOOST_CHECK(!LookupSubNet("1.0.0.0/+24").IsValid());
    BOOST_CHECK(LookupSubNet("1.0.0.0/32").IsValid());
    BOOST_CHECK(!LookupSubNet("1.0.0.0/33").IsValid());
    BOOST_CHECK(!LookupSubNet("1.0.0.0/300").IsValid());
    ...
    BOOST_CHECK(CSubNet(ResolveIP("1.0.0.1")).IsValid());
    BOOST_CHECK(CSubNet(ResolveIP("1.0.0.1")).Match(ResolveIP("1.0.0.1")));
    BOOST_CHECK(!CSubNet(ResolveIP("1.0.0.1")).Match(ResolveIP("1.0.0.2")));
    BOOST_CHECK(CSubNet(ResolveIP("1.0.0.1")).ToString() == "1.0.0.1/32");

    CSubNet subnet = CSubNet(ResolveIP("1.0.0.4"), 32);
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.4/32");
    subnet = CSubNet(ResolveIP("1.0.0.4"), 8);
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/8");
    subnet = CSubNet(ResolveIP("1.0.0.4"), 0);
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/0");

    subnet = CSubNet(ResolveIP("1.0.0.4"), ResolveIP("1.0.0.255"));
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.4/32");
    subnet = CSubNet(ResolveIP("1.0.0.4"), ResolveIP("1.0.0.0"));
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/8");
    subnet = CSubNet(ResolveIP("1.0.0.4"), ResolveIP("1.0.0.0"));
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/0");
    ...
    BOOST_CHECK(!CSubNet(ResolveIP("1.0.0.1"), ResolveIP("ffff::")).IsValid());
    BOOST_CHECK(!CSubNet(ResolveIP("::1"), ResolveIP("1.0.0.0")).IsValid());
    ...
    BOOST_CHECK(!subnet.Match(ResolveIP("1.0.0.4")));

    BOOST_CHECK(!CSubNet(tor_addr, 200).IsValid());
    BOOST_CHECK(!CSubNet(tor_addr, ResolveIP("1.0.0.0")).IsValid());

    subnet = LookupSubNet("1.0.0.4/1.0.0.255");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.4/32");
    subnet = LookupSubNet("1.0.0.4/1.0.0.254");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.4/31");
    subnet = LookupSubNet("1.0.0.4/1.0.0.252");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.4/30");
    subnet = LookupSubNet("1.0.0.4/1.0.0.248");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/29");
    subnet = LookupSubNet("1.0.0.4/1.0.0.240");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/28");
    subnet = LookupSubNet("1.0.0.4/1.0.0.224");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/27");
    subnet = LookupSubNet("1.0.0.4/1.0.0.192");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/26");
    subnet = LookupSubNet("1.0.0.4/1.0.0.128");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/25");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/24");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/23");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/22");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/21");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/20");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/19");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/18");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/17");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/16");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/15");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    ...
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/8");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/7");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/6");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/5");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/4");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/3");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/2");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/1");
    subnet = LookupSubNet("1.0.0.4/1.0.0.0");
    BOOST_CHECK_EQUAL(subnet.ToString(), "1.0.0.0/0");
...
BOOST_AUTO_TEST_CASE(netbase_getgroup)
{
    ...
    BOOST_CHECK(netgroupman.GetGroup(ResolveIP("1.0.0.1")) == std::vector<unsigned char>({0})); // Local -> !Routable()
    BOOST_CHECK(netgroupman.GetGroup(ResolveIP("1.0.0.1")) == std::vector<unsigned char>({0})); // !Valid -> !Routable()
    BOOST_CHECK(netgroupman.GetGroup(ResolveIP("1.0.0.1")) == std::vector<unsigned char>({0})); // RFC1918 -> !Routable()
    BOOST_CHECK(netgroupman.GetGroup(ResolveIP("1.0.0.1")) == std::vector<unsigned char>({0})); // RFC3927 -> !Routable()
    BOOST_CHECK(netgroupman.GetGroup(ResolveIP("1.0.0.4")) == std::vector<unsigned char>({(unsigned char)NET_IPV4, 1, 2})); // IPv4
...
BOOST_AUTO_TEST_CASE(netpermissions_test)
{
    ...
    BOOST_CHECK(!NetWhitebindPermissions::TryParse("1.0.0.1", whitebindPermissions, error));
    ...
    BOOST_CHECK(NetWhitebindPermissions::TryParse("1.0.0.4:32", whitebindPermissions, error));
    ...
    BOOST_CHECK(NetWhitebindPermissions::TryParse("bloom@1.0.0.4:32", whitebindPermissions, error));
    ...
    BOOST_REQUIRE(NetWhitebindPermissions::TryParse("noban@1.0.0.4:32", noban, error));
    ...
    BOOST_REQUIRE(NetWhitebindPermissions::TryParse("noban,download@1.0.0.4:32", noban_download, error));
    BOOST_CHECK_EQUAL(noban_download.m_flags, noban.m_flags);

    // "download,noban" is equivalent to "noban"
    BOOST_REQUIRE(NetWhitebindPermissions::TryParse("download,noban@1.0.0.4:32", download_noban, error));
    BOOST_CHECK_EQUAL(download_noban.m_flags, noban.m_flags);

    // "download" excludes (does not imply) "noban"
    BOOST_REQUIRE(NetWhitebindPermissions::TryParse("download@1.0.0.4:32", download, error));
    ...
    BOOST_CHECK(NetWhitebindPermissions::TryParse("bloom,forcerelay@1.0.0.4:32", whitebindPermissions, error));
    ...
    BOOST_CHECK(NetWhitebindPermissions::TryParse("bloom,relay,noban@1.0.0.4:32", whitebindPermissions, error));
    ...
    BOOST_CHECK(NetWhitebindPermissions::TryParse("bloom,forcerelay,noban@1.0.0.4:32", whitebindPermissions, error));
    BOOST_CHECK(NetWhitebindPermissions::TryParse("all@1.0.0.4:32", whitebindPermissions, error));
    BOOST_CHECK_EQUAL(whitebindPermissions.m_flags, NetPermissionFlags::All);

    // Allow dups
    BOOST_CHECK(NetWhitebindPermissions::TryParse("bloom,relay,noban,noban@1.0.0.4:32", whitebindPermissions, error));
    ...
    BOOST_CHECK(!NetWhitebindPermissions::TryParse("out,forcerelay@1.0.0.4:32", whitebindPermissions, error));
    BOOST_CHECK(error.original.find("whitebind may only be used for incoming connections (\"out\" was passed)") != std::string::npos);

    // Detect invalid flag
    BOOST_CHECK(!NetWhitebindPermissions::TryParse("bloom,forcerelay,oopsie@1.0.0.4:32", whitebindPermissions, error));
    BOOST_CHECK(error.original.find("Invalid P2P permission") != std::string::npos);

    // Check netmask error
    BOOST_CHECK(!NetWhitelistPermissions::TryParse("bloom,forcerelay,noban@1.0.0.4:32", whitelistPermissions, connection_direction, error));
    BOOST_CHECK(error.original.find("Invalid netmask specified in -whitelist") != std::string::npos);

    // Happy path for whitelist parsing
    BOOST_CHECK(NetWhitelistPermissions::TryParse("noban@1.0.0.4", whitelistPermissions, connection_direction, error));
    ...
    BOOST_CHECK(NetWhitelistPermissions::TryParse("bloom,forcerelay,noban,relay@1.0.0.4/32", whitelistPermissions, connection_direction, error));
    ...
    BOOST_CHECK(error.empty());
    BOOST_CHECK_EQUAL(whitelistPermissions.m_subnet.ToString(), "1.0.0.4/32");
    BOOST_CHECK(NetWhitelistPermissions::TryParse("bloom,forcerelay,noban,relay,mempool@1.0.0.4/32", whitelistPermissions, connection_direction, error));
    BOOST_CHECK(NetWhitelistPermissions::TryParse("in,relay@1.0.0.4", whitelistPermissions, connection_direction, error));
    BOOST_CHECK_EQUAL(connection_direction, ConnectionDirection::In);
    BOOST_CHECK(NetWhitelistPermissions::TryParse("out,bloom@1.0.0.4", whitelistPermissions, connection_direction, error));
    BOOST_CHECK_EQUAL(connection_direction, ConnectionDirection::Out);
    BOOST_CHECK(NetWhitelistPermissions::TryParse("in,out,bloom@1.0.0.4", whitelistPermissions, connection_direction, error));
...
{
    BOOST_CHECK(LookupHost("1.0.0.1"s, false).has_value());
    BOOST_CHECK(!LookupHost("1.0.0.1\0"s, false).has_value());
    BOOST_CHECK(!LookupHost("1.0.0.1\0example.com"s, false).has_value());
    BOOST_CHECK(!LookupHost("1.0.0.1\0example.com\0"s, false).has_value());

    BOOST_CHECK(LookupSubNet("1.0.0.0/24"s).IsValid());
    BOOST_CHECK(!LookupSubNet("1.0.0.0/24\0"s).IsValid());
    BOOST_CHECK(!LookupSubNet("1.0.0.0/24\0example.com"s).IsValid());
    BOOST_CHECK(!LookupSubNet("1.0.0.0/24\0example.com\0"s).IsValid());
