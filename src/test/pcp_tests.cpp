...
public:
    ...
    {
        const std::optional<CService> local_ipv4{Lookup("1.0.0.6", 1, false)};
        const std::optional<CService> local_ipv6{Lookup("2a10:1234:5678:9abc:def0:1234:5678:9abc", 1, false)};
        const std::optional<CService> gateway_ipv4{Lookup("1.0.0.1", 1, false)};
...
BOOST_AUTO_TEST_CASE(natpmp_ipv4)
{
    ...
    BOOST_CHECK_EQUAL(mapping->internal.ToStringAddrPort(), "1.0.0.6:1234");
    BOOST_CHECK_EQUAL(mapping->external.ToStringAddrPort(), "1.0.0.4:1234");
