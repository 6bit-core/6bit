...
// Copyright (c) 2026 The sixbit Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/license/mit/.

#ifndef SIXBIT_CLIENTVERSION_H
#define SIXBIT_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by sixbit-build-config.h or in any other way
#endif
