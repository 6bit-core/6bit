...
int main(int argc, char** argv)
{
    ...
    if (HelpRequested(argsman)) {
        std::cout << "Usage:  bench.sixbit [options]\n"
                     "\n"
                  << argsman.GetHelpMessage()
                  << "Description:\n"
                     "\n"
                     "  bench.sixbit executes microbenchmarks. The quality of the benchmark results\n"
                     ...
                     "\n"
                     "  * bench.sixbit uses nanobench [3] for which there is extensive\n"
                     ...
                     "\n"
                     "    NANOBENCH_ENDLESS=MuHash ./bench.sixbit -filter=MuHash\n"
                     "\n"
                     ...
                     "\n"
                     "    NANOBENCH_SUPPRESS_WARNINGS=1 ./bench.sixbit\n"
                     "\n"
                     "Notes:\n"
                     "\n"
                     "  1. pyperf\n"
