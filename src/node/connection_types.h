...
#ifndef SIXBIT_NODE_CONNECTION_TYPES_H
#define SIXBIT_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/sixbit-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on sixbit.s Peer-to-Peer Network")
...
#endif // SIXBIT_NODE_CONNECTION_TYPES_H
