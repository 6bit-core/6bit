...
#ifndef SIXBIT_INTERFACES_INIT_H
#define SIXBIT_INTERFACES_INIT_H
...
//! (sixbit-gui, sixbit-node, sixbit-wallet, sixbitd, sixbit-qt) and each
...
#endif // SIXBIT_INTERFACES_INIT_H
