...
#ifndef SIXBIT_INTERFACES_NODE_H
#define SIXBIT_INTERFACES_NODE_H
...
//! Top-level interface for a.sixbit node (sixbitd process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or sixbit.conf.
...
#endif // SIXBIT_INTERFACES_NODE_H
