...
#ifndef SIXBIT_CONSENSUS_PARAMS_H
#define SIXBIT_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a sixbit Script solution
...
#endif // SIXBIT_CONSENSUS_PARAMS_H
