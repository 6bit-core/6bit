...
#ifndef SIXBIT_POLICY_FEERATE_H
#define SIXBIT_POLICY_FEERATE_H
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::SIXBIT_KVB) const;
