...
#ifndef SIXBIT_WALLET_WALLETUTIL_H
#define SIXBIT_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //!.sixbit from opening the wallet, thinking it was newly created, and
...
#endif // SIXBIT_WALLET_WALLETUTIL_H
