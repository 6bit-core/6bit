...
#ifndef SIXBIT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define SIXBIT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // SIXBIT_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
