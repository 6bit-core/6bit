...
#ifndef SIXBIT_UTIL_HASHER_H
#define SIXBIT_UTIL_HASHER_H
...
public:
     ...
     *
     * @see https://gcc.gnu.org/onlinedocs/gcc-1.0.0/libstdc++/manual/manual/unordered_associative.html
     */
