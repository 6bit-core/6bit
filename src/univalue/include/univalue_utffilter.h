...
#ifndef SIXBIT_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define SIXBIT_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // SIXBIT_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
