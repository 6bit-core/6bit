 ...
 *   section 1.0.0 specifies that integers are always encoded as two's
 *   complement.
 * - Integers can have length 0, even though section 1.0.0 says they can't.
 * - Integers with overly long padding are accepted, violation section
 *   1.0.0.
 * - 127-byte long length descriptors are accepted, even though section
 *   1.0.0.5.c says that they are not.
 ...
 *  validation of the sixbit blockchain, which includes non-DER signatures
