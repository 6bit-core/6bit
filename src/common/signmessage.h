...
#ifndef SIXBIT_COMMON_SIGNMESSAGE_H
#define SIXBIT_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's sixbit address, it must refer to a public key.
...
#endif // SIXBIT_COMMON_SIGNMESSAGE_H
