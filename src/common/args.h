...
#ifndef SIXBIT_COMMON_ARGS_H
#define SIXBIT_COMMON_ARGS_H
...
extern const char * const SIXBIT_CONF_FILENAME;
extern const char * const SIXBIT_SETTINGS_FILENAME;
