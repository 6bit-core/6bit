...
#ifndef SIXBIT_ARITH_UINT256_H
#define SIXBIT_ARITH_UINT256_H
...
public:
     ...
     *
     * sixbit only uses this "compact" format for encoding difficulty
     * targets, which are unsigned 25sixbit quantities.  Thus, all the
