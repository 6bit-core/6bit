...
#ifndef SIXBIT_IPC_CAPNP_COMMON_TYPES_H
#define SIXBIT_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between sixbit processes.
...
//! Functions to serialize / deserialize common sixbit types.
namespace mp {
...
#endif // SIXBIT_IPC_CAPNP_COMMON_TYPES_H
