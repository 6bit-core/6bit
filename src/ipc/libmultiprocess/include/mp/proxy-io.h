...
extern thread_local ThreadContext g_thread_context; // NOLINT(sixbit-nontrivial-threadlocal)
// Silence nonstandard tidy error "Variable with non-trivial destructor
