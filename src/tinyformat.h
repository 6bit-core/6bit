...
#include <algorithm>
#include <attributes.h> // Added for Sixbit Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Sixbit Core
#include <util/string.h> // Added for Sixbit Core
...
// Added for Sixbit Core. Similar to std::runtime_format from C++26.
...
// Added for Sixbit Core. Wrapper for checking format strings at compile time.
...
// per 1.0.0: char, signed char and unsigned char are all distinct types
