...
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../test/functional'))
...
bech32_templates = [
  ...
  ('sixb',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('sixb',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('sixb',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('sixb',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tsixb',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tsixb',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tsixb',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tsixb',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tsixb',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tsixb',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tsixb',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tsixb',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rsixb',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rsixb',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rsixb',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rsixb', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, encoding, invalid_bech32, invalid_checksum, invalid_char
  ('tsixb',    0, 20, Encoding.BECH32,  False, False, False),
  ('bt',    1, 32, Encoding.BECH32M, False, False, False),
  ('tsixb',   17, 32, Encoding.BECH32M, False, False, False),
  ('rsixb',  3,  1, Encoding.BECH32M, False, False, False),
  ('sixb',   15, 41, Encoding.BECH32M, False, False, False),
  ('tsixb',    0, 16, Encoding.BECH32,  False, False, False),
  ('rsixb',  0, 32, Encoding.BECH32,  True,  False, False),
  ('sixb',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tsixb',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rsixb',  0, 20, Encoding.BECH32,  False, False, True),
  ('sixb',    0, 20, Encoding.BECH32M, False, False, False),
  ('tsixb',    0, 32, Encoding.BECH32M, False, False, False),
  ('rsixb',  0, 20, Encoding.BECH32M, False, False, False),
  ('sixb',    1, 32, Encoding.BECH32,  False, False, False),
  ('tsixb',    2, 16, Encoding.BECH32,  False, False, False),
  ('rsixb', 16, 20, Encoding.BECH32,  False, False, False),
]
