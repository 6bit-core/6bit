...
complete --command sixbitd --no-files

# Extract options
function __fish_sixbitd_get_options
...
complete \
    --command sixbitd \
    --arguments "(__fish_sixbitd_get_options --nofiles)"
