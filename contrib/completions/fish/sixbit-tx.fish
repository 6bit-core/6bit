...
# Extract options
function __fish_sixbit_tx_get_options
...
# Extract commands
function __fish_sixbit_tx_get_commands
...
complete \
    --command sixbit-tx \
    --condition "not __fish_sixbit_seen_cmd (__fish_sixbit_tx_get_commands --commandsonly)" \
    --arguments "(__fish_sixbit_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command sixbit-tx \
    --arguments "(__fish_sixbit_tx_get_commands)" \
    --no-files
