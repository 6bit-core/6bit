...
(define* (make-sixbit-cross-toolchain target
                                       #:key
...
desirable for building Sixbit Core release binaries."
...
;; failure; see https://github.com/sixbit/sixbit/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-sixbit-cross-toolchain target)))
