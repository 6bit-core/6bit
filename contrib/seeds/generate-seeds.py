...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef 6BIT_CHAINPARAMSSEEDS_H\n')
    g.write('#define 6BIT_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the sixbit network\n')
    ...
    g.write('#endif // 6BIT_CHAINPARAMSSEEDS_H\n')
