...
UNSIGNED_BINARY="${UNSIGNED_BUNDLE}/Contents/MacOS/${APP_NAME}"
...
command -v "${SIGNAPPLE}" >/dev/null 2>&1 || { echo "signapple not found"; exit 1; }

[ -f "${UNSIGNED_BINARY}" ] || { echo "Binary not found: ${UNSIGNED_BINARY}"; exit 1; }
