...
#include "/home/ubuntu/6bit/src/qt/recentrequeststablemodel.h"
...
struct qt_meta_stringdata_CLASSRecentRequestsTableModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSRecentRequestsTableModelENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSRecentRequestsTableModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject RecentRequestsTableModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSRecentRequestsTableModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSRecentRequestsTableModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRecentRequestsTableModelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *RecentRequestsTableModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSRecentRequestsTableModelENDCLASS.stringdata0))
