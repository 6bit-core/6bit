...
#include "/home/ubuntu/6bit/src/qt/notificator.h"
...
struct qt_meta_stringdata_CLASSNotificatorENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSNotificatorENDCLASS = QtMocHelpers::stringData(
    "Notificator",
    "notify",
    "",
    "Class",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSNotificatorENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Notificator::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSNotificatorENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSNotificatorENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSNotificatorENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Notificator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSNotificatorENDCLASS.stringdata0))
