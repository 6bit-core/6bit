...
#include "/home/ubuntu/6bit/src/qt/initexecutor.h"
...
struct qt_meta_stringdata_CLASSInitExecutorENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSInitExecutorENDCLASS = QtMocHelpers::stringData(
    "InitExecutor",
    "initializeResult",
    "",
    "success",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSInitExecutorENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject InitExecutor::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSInitExecutorENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSInitExecutorENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSInitExecutorENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void InitExecutor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &InitExecutor::initializeResult; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &InitExecutor::shutdownResult; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &InitExecutor::runawayException; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *InitExecutor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSInitExecutorENDCLASS.stringdata0))
