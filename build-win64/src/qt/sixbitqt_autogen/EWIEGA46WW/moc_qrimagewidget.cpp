...
#include "/home/ubuntu/6bit/src/qt/qrimagewidget.h"
...
struct qt_meta_stringdata_CLASSQRImageWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQRImageWidgetENDCLASS = QtMocHelpers::stringData(
    "QRImageWidget",
    "saveImage",
    "",
    "copyImage"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQRImageWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QRImageWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQRImageWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQRImageWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQRImageWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QRImageWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQRImageWidgetENDCLASS.stringdata0))
