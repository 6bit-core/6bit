...
#include "/home/ubuntu/6bit/src/qt/addressbookpage.h"
...
struct qt_meta_stringdata_CLASSAddressBookPageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAddressBookPageENDCLASS = QtMocHelpers::stringData(
    "AddressBookPage",
    "sendCoins",
    "",
    "addr",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAddressBookPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AddressBookPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAddressBookPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAddressBookPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAddressBookPageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *AddressBookPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAddressBookPageENDCLASS.stringdata0))
