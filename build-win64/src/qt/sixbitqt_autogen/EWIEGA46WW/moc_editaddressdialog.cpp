...
#include "/home/ubuntu/6bit/src/qt/editaddressdialog.h"
...
struct qt_meta_stringdata_CLASSEditAddressDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSEditAddressDialogENDCLASS = QtMocHelpers::stringData(
    "EditAddressDialog",
    "accept",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSEditAddressDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject EditAddressDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSEditAddressDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSEditAddressDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSEditAddressDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *EditAddressDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSEditAddressDialogENDCLASS.stringdata0))
