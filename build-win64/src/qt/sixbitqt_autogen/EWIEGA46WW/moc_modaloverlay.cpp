...
#include "/home/ubuntu/6bit/src/qt/modaloverlay.h"
...
struct qt_meta_stringdata_CLASSModalOverlayENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSModalOverlayENDCLASS = QtMocHelpers::stringData(
    "ModalOverlay",
    "triggered",
    "",
    "hidden",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSModalOverlayENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ModalOverlay::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSModalOverlayENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSModalOverlayENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSModalOverlayENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void ModalOverlay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ModalOverlay::triggered; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ModalOverlay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSModalOverlayENDCLASS.stringdata0))
