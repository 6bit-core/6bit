...
#include "/home/ubuntu/6bit/src/qt/receiverequestdialog.h"
...
struct qt_meta_stringdata_CLASSReceiveRequestDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSReceiveRequestDialogENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSReceiveRequestDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ReceiveRequestDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSReceiveRequestDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSReceiveRequestDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSReceiveRequestDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ReceiveRequestDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSReceiveRequestDialogENDCLASS.stringdata0))
