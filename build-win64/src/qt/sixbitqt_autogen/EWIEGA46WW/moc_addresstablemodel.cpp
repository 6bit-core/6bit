...
#include "/home/ubuntu/6bit/src/qt/addresstablemodel.h"
...
struct qt_meta_stringdata_CLASSAddressTableModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAddressTableModelENDCLASS = QtMocHelpers::stringData(
    "AddressTableModel",
    "updateEntry",
    "",
    "address",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAddressTableModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AddressTableModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAddressTableModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAddressTableModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAddressTableModelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *AddressTableModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAddressTableModelENDCLASS.stringdata0))
