...
#include "/home/ubuntu/6bit/src/qt/walletframe.h"
...
struct qt_meta_stringdata_CLASSWalletFrameENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSWalletFrameENDCLASS = QtMocHelpers::stringData(
    "WalletFrame",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSWalletFrameENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject WalletFrame::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSWalletFrameENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSWalletFrameENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSWalletFrameENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void WalletFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &WalletFrame::createWalletButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &WalletFrame::message; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (WalletFrame::*)();
            if (_t _q_method = &WalletFrame::currentWalletSet; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *WalletFrame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSWalletFrameENDCLASS.stringdata0))
