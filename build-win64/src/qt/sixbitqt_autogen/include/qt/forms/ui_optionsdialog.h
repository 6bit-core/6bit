...
public:
    ...
    QPushButton *opensixbitConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        sixbitAtStartup = new QCheckBox(tabMain);
        sixbitAtStartup->setObjectName("sixbitAtStartup");

        verticalLayout_Main->addWidget(sixbitAtStartup);
...
"909.09090909 BTC"));
        ...
        opensixbitConfButton = new QPushButton(OptionsDialog);
        opensixbitConfButton->setObjectName("opensixbitConfButton");
        opensixbitConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(opensixbitConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        sixbitAtStartup->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", nullptr));
#endif // QT_CONFIG(tooltip)
        sixbitAtStartup->setText(QCoreApplication::translate("OptionsDialog", "&Start %1 on system login", nullptr));
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        mapPortNatpmp->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically open the sixbit client port on the router. This only works when your router supports PCP or NAT-PMP and it is enabled. The external port could be random.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocks->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the sixbit network through a SOCKS5 proxy.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocksTor->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the sixbit network through a separate SOCKS5 proxy for Tor onion services.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        opensixbitConfButton->setToolTip(QCoreApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", nullptr));
#endif // QT_CONFIG(tooltip)
        opensixbitConfButton->setText(QCoreApplication::translate("OptionsDialog", "Open Configuration File", nullptr));
#if QT_CONFIG(tooltip)
